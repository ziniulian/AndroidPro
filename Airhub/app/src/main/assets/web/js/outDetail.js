function init() {
    ...
    if (!ol.rid) {
        ...
        scana.href = "outScan.html?rid=" + ol.rid;
    }
    ol.flush();
}
...
ol = {
    ...
    del: function (evt) {
        if (!ol.busy && ol.getAjax()) {
            ...
            var msg = "srv=delOneBorrow&rid=" + ol.rid + "&devid=" + ol.busy.getAttribute("devid");
            ol.ajx.send(msg);
        }
    },
